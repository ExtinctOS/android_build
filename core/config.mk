...
ifneq ($(EXTINCT_BUILD),)
ifneq ($(wildcard device/extinct/sepolicy/common/sepolicy.mk),)
## We need to be sure the global selinux policies are included
## last, to avoid accidental resetting by device configs
$(eval include device/extinct/sepolicy/common/sepolicy.mk)
endif
endif
...
else ifneq ($(filter vendor/extinct-priv/%,$(DEFAULT_SYSTEM_DEV_CERTIFICATE)),)
